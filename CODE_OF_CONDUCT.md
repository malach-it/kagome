...
This code of conduct expresses ethical community expectations and moderation standards. It is intended as a community framework rather than a legal instrument, is not intended to create independent legal obligations, and does not replace applicable law or legal rights and obligations.

## 2. What is a violation?

The purpose of this document is to set the limits and how to mitigate when violations occur. First of all, suspected violations of applicable law should be reported through appropriate channels where safe and appropriate for the healthiness of our interactions. We would make focus on harassment and all kind of discrimination against ancestry, age, color, religion, caste, origin, race, personal appearance, nationality, socio-economic status, level of experience, gender identity and expression, sex characteristics, ethnicity, sexual identity and orientation, visible or invisible disability, body size, and other private or personal information that can be used for harming purposes.

## 3. What is a contribution?

Are considered contributions, the produced code and all derived material propagated under the copyright provided by this repository of code. Other material out of this scope is not considered contributions to this project, except where conduct involving that material affects the project or its community. Also, any official representation of the product may be considered as a contribution. Those need a written validation from the owners of the project.

## 4. In accordance with the product vision

The contributions to this project should fit its vision. Contributions that diverge from it may be declined if not consented to by the owner, but divergence alone is not a violation of this code of conduct. The vision of the project is stated as:

Kagome makes the formation and propagation of trust explicit: it provides open, inspectable, and privacy-respecting foundations for people and systems to establish, carry, verify, and responsibly act on trustworthy identity claims. This vision is informed by the ChatGPT-assisted Astra model and is intentionally a working statement to be refined as the model, the research, and the project evolve.
...
The first responsibility is to report violations that are described above (section 2). Community members are encouraged to report such violations to the right person following an escalation process. That person will be named here as a facilitator of escalation, described next.
...
Within the community, mediation of the situations of violation is made by resolving the conflicts. The responsible person for this should be trained to conflict resolution using methods like Non-Violent Communication from Rosenberg or other peaceful ways of resolution. The responsibility includes finding external resources to solve the conflict and, where appropriate, contacting authorities in case of grave violation or suspected violation of applicable law.

Once again, all community members are encouraged to report issues, as reporting is the basis for a healthy community. Starting by navigating within the frame, ensuring psychological safety is also needed for us to evolve as a community.
...
The escalation process may suit the community integrating it, then as finding the roles, one may find a collective track to find the best way to mitigate issues. As a minimal process, the project owner must leave an explicit way to report abuse. As a reminder, all community members are encouraged to report violations of the present code of conduct. Reports may be made anonymously where the reporting channel supports it and will be handled confidentially where possible to reduce the risk of retaliation. The people responsible for facilitation can keep track of the report, find the best people to mitigate it within the community (it can be himself), and the mediation can begin.

Then comes the mediation, for a low-importance violation, the mediator can facilitate communication and take action against the abuse. In case of public violation, the impactful content is to be removed. Actions may be temporary or permanent bans from the community for example. The issue of the mediation may be tracked privately by the facilitator for audit purposes but also to mediate if the violation comes up again. A record may be made public only where appropriate, with due regard for confidentiality, safety, and applicable law. He can also find ways to improve the escalation process or trigger a role redefinition within the community.

In case of a grave violation, suspected violation of applicable law, or credible risk of harm, the project owner may contact the relevant authorities and the community should cooperate where safe and appropriate.
...
Adapted from the [malach-it Code of Conduct](https://github.com/malach-it/code_of_conduct); changes were made for Kagome.
